<script>
   ...
   export let data;
   const book = JSON.parse(data.ebook)
...
<main>
   ...
   <div class="flex m-5 justify-between gap-5">
      <div class="min-w-44 hidden flex lg:block lg:min-w-52 rounded-[5px] h-[300px] "> 
         <img class="lg:w-full self-center w-44" src="{book[0].photoURL}">
      </div>
      <div class="flex flex-col gap-5">
         <h1>{book[0].name}</h1>
         <div class="h-[300px] flex lg:hidden items-center justify-center "> 
            <img class="h-full rounded-lg" src="{book[0].photoURL}">
         </div>
         <div class="w-full flex gap-3">
            <div class="border border-orange-600 p-5 flex-1"> 
               EBOOK
            </div>
            <div class="border border-orange-600 p-5 flex-1">
               PAPER BACK
         ...
         <div class="min-w-80 lg:hidden flex flex-col gap-3 rounded-[5px]">
            <div class="flex gap-2">
               <p>Quantity</p>
               <div>- 1 +</div>
            </div>
            <button class="border border-orange-600 hover:bg-orange-600 rounded-lg py-2 w-full">Add Paperback to Cart</button>
            <button class="border border-orange-600 hover:bg-orange-600 rounded-lg py-2 w-full">Get Paperback Now</button>
         </div>
      ...
      <div class="min-w-80 p-4 hidden lg:flex flex-col font-semibold justify-between h-[450px] rounded-[5px] bg-orange-100">
         ...
         <div class="flex flex-col justify-center items-center">
            <p>Share this Book</p>
            <div class="flex gap-2">
               <img src="facebook.png" alt="fac" />
               <img src="twitter.png" alt="twr" />
