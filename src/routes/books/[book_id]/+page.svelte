   ...
   <div class="flex m-5 justify-between gap-5">
      ...
      <div class="flex flex-col gap-6">
          ...
          <div class=" w-full flex lg:w-44">
            ...
            <div on:click={togglePaperClass} class={`cursor-pointer py-2 pl-4 w-[50%] border-2 ml-[-1px] rounded-r-lg ${pClicked ? "bg-orange-100  border-orange-600" : "border-gray-300"}`}>
          ...
          <div class="md:hidden flex justify-between items-center ">
            <div class="flex items-center gap-2">
                <h2>Quantity:</h2>
                <div class="border items-center font-semibold flex gap-7 px-3 py-1">
                    <button on:click={()=> {
         ...
         <div class="min-w-80 lg:hidden flex flex-col gap-4 rounded-[5px] ">
            ...
            <button class="hover:bg-orange-100 border  text-lg text-orange-600 rounded-lg py-2 border-orange-600">Get eBook now</button>
