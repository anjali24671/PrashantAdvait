...
<div class="m-4">
    <div>
        ...
        <div class="flex md:flex-row flex-col gap-4">
            ...
            <div>
                <h2>most eminent of 108 upanishad</h2>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sint fugiat nobis amet incidunt deleniti, enim provident! Harum eius repellat aliquam error laudantium reprehenderit, quibusdam vitae sed modi, obcaecati molestias doloremque?
                Cum, tempora. Quaerat praesentium dicta tempora, pariatur doloribus optio perferendis magni officiis aspernatur quia ipsa perspiciatis ea dolorum maxime beatae rem veniam architecto, obcaecati fugiat? Nihil temporibus reiciendis veritatis? Sit!
                Eius, fugiat. Totam, repellendus? Fugit ad, tempore aliquam iure nemo facilis facere enim aut optio reiciendis illo unde totam at similique sit sed ex saepe, id dolorum asperiores quidem? Hic?</p>
            </div>
        </div>
    </div>
