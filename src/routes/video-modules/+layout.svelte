    ...
    <header class="mx-4 my-6 mb-[40px] flex items-center  gap-2">
        ...
        <div class="flex gap-4 flex-col border overflow-hidden rounded-[8px]">
            <div class="flex md:w-[660px] relative">
                ...
                <input bind:value={inputQuery} class="w-full outline-none p-2 md:px-2 md:px-[40px] md:rounded-[0px] rounded-[8px]" placeholder="search for videos">
                ...
                <button on:click={setQuery} class="md:hidden block self-center  mx-2 ">
