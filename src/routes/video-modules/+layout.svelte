    ...
    <header class="mx-4 my-2 flex gap-2">
        ...
        <div class="flex gap-4 flex-col border overflow-hidden rounded-[8px]">
            <div class="flex md:w-[660px] relative">
                ...
                <input  class="w-full p-2 md:px-2 px-[40px] md:rounded-[0px] rounded-[8px]" placeholder="search for videos">
                <button  class="md:bg-orange-200 p-2 absolute h-full md:right-0">
